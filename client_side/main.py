...
class CourseAppGUI:
  def __init__(self, master, baseurl):
    ...
    self.label = ttk.Label(frame, text="Welcome to CourseApp!", font=customFont, background=darker_blue)
    ...
    self.get_jobs_button = ttk.Button(frame,
                                      text="List all course materials",
  ...
  def jobs(self, baseurl):
    ...
    try:
      api = '/jobs'
      url = baseurl + api
      print("Our Course Materials list is: \n")
      res = requests.get(url)
